...
Light, Fast simple game managing teams and players with simulating budget with random players statistics

Using Cordova Camera and Framework7 
...
```
{
  "cwd": "D:\\New folder\\SoccerPlanner",
  "type": [
    "web",
    "pwa",
    "cordova"
